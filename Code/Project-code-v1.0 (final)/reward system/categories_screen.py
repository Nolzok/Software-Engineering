...
def show_categories_screen(root, controller):
    ...
    def on_select(category):
        show_category_screen(root, controller, category)
        categories_window.destroy()

    # Κουμπιά Κατηγοριών
    for category in ["Αθλητισμός", "Διασκέδαση", "Τεχνολογία", "Πολιτισμός", "Μουσική", "Εκπαίδευση", "Τέχνη","Επιχειρηματικότητα", "Υγεία & Ευεξία" ]:
